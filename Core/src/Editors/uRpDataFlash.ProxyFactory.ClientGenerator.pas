unit uRpDataFlash.ProxyFactory.ClientGenerator;
      ...
      try
        ...
        begin
          ...
          if FileExists(FNomeUnitProxy) then
            lContinua := MessageDlg('The file already exists. Do you wish to continue?'#10#13 + FNomeUnitProxy, mtWarning, mbYesNo, 0) = idYes
          else
            lContinua := True;
...
begin
  case Index of
    0 : Result := 'Generate Proxy Classes';
    else
